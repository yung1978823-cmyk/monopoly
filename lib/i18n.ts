...
const DICT: Record<string, { hans: string; en: string }> = {
  ...
  // 領地 (new plan)
  "🏰 領地": { hans: "🏰 领地", en: "🏰 Realm" },
  領地列表: { hans: "领地列表", en: "All realms" },
  我嘅錢同材料: { hans: "我的钱和材料", en: "My money and materials" },
  呢度仲係一片空地: { hans: "这里还是一片空地", en: "This is still an empty plot" },
  買咗地先可以起屋同開局: { hans: "买了地才可以盖楼和开局", en: "Buy land first, then build and open it" },
  "{n} 格 · {s} 個建造位": { hans: "{n} 格 · {s} 个建造位", en: "{n} squares · {s} build slots" },
  買地: { hans: "买地", en: "Buy" },
  即將推出: { hans: "即将推出", en: "Coming soon" },
  "{owner} 嘅{land}": { hans: "{owner} 的{land}", en: "{owner}'s {land}" },
  免費入場: { hans: "免费入场", en: "Free entry" },
  "門票 {n}": { hans: "门票 {n}", en: "Ticket {n}" },
  "最少 {n} 人開局": { hans: "最少 {n} 人开局", en: "Starts with {n}+ players" },
  管理: { hans: "管理", en: "Manage" },
  "練習版：地主同客人都係電腦": { hans: "练习版：地主和客人都是电脑", en: "Practice: owners and guests are computer players" },
  "我嘅{land}": { hans: "我的{land}", en: "My {land}" },
  拆咗嘅建築唔會退返材料: { hans: "拆掉的建筑不会退回材料", en: "Removing a building doesn't refund its materials" },
  "材料店（臨時價，買材料嘅錢會銷毀）": { hans: "材料店（临时价，买材料的钱会销毁）", en: "Material shop (temporary prices; the money is burned)" },
  ...
  臨時配方: { hans: "临时配方", en: "Temporary recipe" },
  "{x}減一": { hans: "{x}减一", en: "{x} −1" },
  "{x}加一": { hans: "{x}加一", en: "{x} +1" },
  海島: { hans: "海岛", en: "Island" },
  山城: { hans: "山城", en: "Mountain Town" },
  火山: { hans: "火山", en: "Volcano" },
  "圓形小島，中間有燈塔，碼頭可以坐船": { hans: "圆形小岛，中间有灯塔，码头可以坐船", en: "A round island with a lighthouse; take a boat from the pier" },
  "之字山路，上山落山，有纜車": { hans: "之字山路，上山下山，有缆车", en: "A zigzag mountain road with a cable car" },
  "外圈加內圈兩層，用橋連接": { hans: "外圈加内圈两层，用桥连接", en: "Outer and inner rings joined by bridges" },
  木材: { hans: "木材", en: "Wood" },
  石磚: { hans: "石砖", en: "Stone" },
  金塊: { hans: "金块", en: "Gold" },
